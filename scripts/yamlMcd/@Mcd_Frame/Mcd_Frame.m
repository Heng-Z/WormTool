classdef Mcd_Frame
    ...
    properties
        ...
        StageFeedbackTarget = 0;%feedback position of stage in stage units
        ProtocolIsOn =0; %bool whether you're using protocol
        ProtocolStep =0; %what step within protocol is currently selected
        FirstLaser =0; %int 0-100 of relative laser power. -1 means leaser is not being controlled programmatically
        SecondLaser =0; %int 0-100 of relative laser power. -1 means leaser is not being controlled programmatically
